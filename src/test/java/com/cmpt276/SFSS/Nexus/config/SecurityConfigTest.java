...
class SecurityConfigTest {
    ...
    private final AuthenticationSuccessHandler handler = new SecurityConfig().roleBasedSuccessHandler();

    @Test
    void onAuthenticationSuccess_forAdmin_redirectsToAdminUsersPage() throws Exception {
